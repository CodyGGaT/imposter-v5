...
class ShopState extends MusicBeatState
{
    ...
    var charList:Array<String> = ['none','amongbf','redp','greenp', 'blackp', 'whitep', 'pinkp', 'eggous', 'mungusp', 'picolobby', 'bfairship', 'bfg', 'bfmira', 'bfpolus', 'bfsauce', 'dripbf', 'picolobby']; // STOP ADDING TO THIS LIST IM TRYNA GETSHIT WORKING
    ...
    */
    var nodeData:Array<Dynamic> = [
        ...
        ['bottom', 'blackp', 'mungusp', 450, false, 'Red Mungus', "Unlocked by completing the jorsawsee week", BF, COMPLETED, ['o2', 'voting-time', 'turbulence', 'victory']],
        ['right', 'blackp', 'whitep', 450, false, 'White', "Unlocked by completing the yellow week", BF, COMPLETED, ['mando', 'dlow', 'oversight', 'danger', 'double-kill']],
        ['right', 'whitep', 'pinkp', 450, false, 'Pink', "Unlocked by completing the pink week", BF, COMPLETED, ['heartbeat', 'pinkwave', 'pretender']],
        ...
        ['left', 'bfg', 'picolobby', 200, false, 'Roomcode Pico', "Unlocked by completing Roomcode", BF, COMPLETED, ['roomcode']],
        ...
        ['right', 'ham', 'eggous', 300, false, 'Eggous', "its like a Slithering Egg", PET],
