...
class ShopState extends MusicBeatState
{
    ...
    var charList:Array<String> = ['none','amongbf','redp','greenp', 'blackp', 'whitep', 'pinkp', 'bfairship', 'bfg', 'bfmira', 'bfpolus', 'bfsauce', 'dripbf', 'picolobby']; // STOP ADDING TO THIS LIST IM TRYNA GETSHIT WORKING
