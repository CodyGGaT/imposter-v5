...
class AmongFreeplayState extends MusicBeatState
{
	...
	public static function addWeeks():Array<FreeplayWeek>
	{
		...
		weeks.push({
			songs: [
				["Cant Win", "maroon", 'maroon', FlxColor.RED, FROM_STORY_MODE, ['cant-win'], 0, true],
		...
		weeks.push({
			songs: [
				["Lemon Lime", "jadz", 'green', FlxColor.fromRGB(102, 255, 102), FROM_STORY_MODE, ['lemon-lime'], 0, true],
				["Chlorophyll", "jadz", 'green', FlxColor.fromRGB(102, 255, 102), FROM_STORY_MODE, ['chlorophyll'], 0, true],
				["Inflorescence", "jadz", 'green', FlxColor.fromRGB(102, 255, 102), FROM_STORY_MODE, ['inflorescence'], 0, true],
				["Stargazer", "jadz", 'green', FlxColor.fromRGB(102, 255, 102), FROM_STORY_MODE, ['stargazer'], 0, true]
			],
