...
class AmongFreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		portrait.animation.addByIndices('dt', 'Character', [43], null, 24, true);
		portrait.animation.addByIndices('player', 'Character', [44], null, 24, true);
		portrait.animation.addByIndices('jadz', 'Character', [45], null, 24, true);
	...
	public static function addWeeks():Array<FreeplayWeek>
	{
		...
		weeks.push({
			songs: [
				["Sussus Moogus", "impostor", 'red', FlxColor.RED, FROM_STORY_MODE, ['sussus-moogus'], 0, true],
				["Sabotage", "impostor", 'red', FlxColor.RED, FROM_STORY_MODE, ['sabotage'], 0, true],
				["Meltdown", "impostor2", 'red', FlxColor.RED, FROM_STORY_MODE, ['meltdown'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Sussus Toogus", "crewmate", 'green', FlxColor.fromRGB(0, 255, 0), FROM_STORY_MODE, ['sussus-toogus'], 0, true],
				["Lights Down", "impostor3", 'green', FlxColor.fromRGB(0, 255, 0), FROM_STORY_MODE, ['lights-down'], 0, true],
				["Reactor", "impostor3", 'green', FlxColor.fromRGB(0, 255, 0), FROM_STORY_MODE, ['reactor'], 0, true],
				["Ejected", "parasite", 'para', FlxColor.fromRGB(0, 255, 0), FROM_STORY_MODE, ['ejected'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Double Trouble", "dt", 'dt', FlxColor.fromRGB(0, 255, 0), SPECIAL, ['ejected'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Mando", "yellow", 'yellow', FlxColor.fromRGB(255, 218, 67), FROM_STORY_MODE, ['mando'], 0, true],
				["Dlow", "yellow", 'yellow', FlxColor.fromRGB(255, 218, 67), FROM_STORY_MODE, ['dlow'], 0, true],
				["Oversight", "white", 'white', FlxColor.WHITE, FROM_STORY_MODE, ['oversight'], 0, true],
				["Danger", "black", 'black', FlxColor.fromRGB(179, 0, 255), FROM_STORY_MODE, ['danger'], 0, true],
				["Double Kill", "whiteblack", 'black', FlxColor.fromRGB(179, 0, 255), FROM_STORY_MODE, ['double-kill'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Defeat", "black", 'black', FlxColor.fromRGB(179, 0, 255), FROM_STORY_MODE, ['defeat'], 0, true],
				["Finale", "black", 'finale', FlxColor.fromRGB(179, 0, 255), SPECIAL, ['finale'], 0, true],
				["Triple Kill", "black", 'finale', FlxColor.fromRGB(179, 0, 255), FROM_STORY_MODE, ['triple-kill'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Cant Win", "player", 'player', FlxColor.RED, FROM_STORY_MODE, ['cant-win'], 0, true],
				["Ashes", "maroon", 'maroon', FlxColor.fromRGB(181, 0, 0), FROM_STORY_MODE, ['ashes'], 0, true],
				["Magmatic", "maroon", 'maroon', FlxColor.fromRGB(181, 0, 0), FROM_STORY_MODE, ['magmatic'], 0, true],
				["Boiling Point", "boilingpoint", 'bpmar', FlxColor.fromRGB(181, 0, 0), FROM_STORY_MODE, ['boiling-point'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Delusion", "gray", 'grey', FlxColor.fromRGB(139, 157, 168), FROM_STORY_MODE, ['delusion'], 0, true],
				["Blackout", "gray", 'grey', FlxColor.fromRGB(139, 157, 168), FROM_STORY_MODE, ['blackout'], 0, true],
				["Neurotic", "gray", 'grey', FlxColor.fromRGB(139, 157, 168), FROM_STORY_MODE, ['neurotic'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Heartbeat", "pink", 'pink', FlxColor.fromRGB(255, 0, 222), FROM_STORY_MODE, ['heartbeat'], 0, true],
				["Pinkwave", "pink", 'pink', FlxColor.fromRGB(255, 0, 222), FROM_STORY_MODE, ['pinkwave'], 0, true],
				["Pretender", "pretender", 'pink', FlxColor.fromRGB(255, 0, 222), FROM_STORY_MODE, ['pretender'], 0, true]
			],
		...
		weeks.push({
			songs: [["Sauces Moogus", "chef", 'chef', FlxColor.fromRGB(242, 114, 28), SPECIAL, ['ashes', 'delusion', 'heartbeat'], 0, true]],
			section: 1
		});

		weeks.push({
			songs: [
				["O2", "jorsawsee", 'jorsawsee', FlxColor.fromRGB(38, 127, 230), FROM_STORY_MODE, ['o2'], 0, true],
				["Voting Time", "votingtime", 'warchief', FlxColor.fromRGB(153, 67, 196), FROM_STORY_MODE, ['voting-time'], 0, true],
				["Turbulence", "redmungus", 'redmunp', FlxColor.RED, FROM_STORY_MODE, ['turbulence'], 0, true],
				["Victory", "warchief", 'warchief', FlxColor.fromRGB(153, 67, 196), FROM_STORY_MODE, ['victory'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["ROOMCODE", "powers", 'powers', FlxColor.fromRGB(80, 173, 235), SPECIAL, ['victory'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Lemon Lime", "jadz", 'jadz', FlxColor.fromRGB(102, 255, 102), FROM_STORY_MODE, ['lemon-lime'], 0, true],
				["Chlorophyll", "jadz", 'jadz', FlxColor.fromRGB(102, 255, 102), FROM_STORY_MODE, ['chlorophyll'], 0, true],
				["Inflorescence", "jadz", 'jadz', FlxColor.fromRGB(102, 255, 102), FROM_STORY_MODE, ['inflorescence'], 0, true],
				["Stargazer", "jadz", 'jadz', FlxColor.fromRGB(102, 255, 102), FROM_STORY_MODE, ['stargazer'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Sussy Bussy", "tomongus", 'tomo', FlxColor.fromRGB(255, 90, 134), FROM_STORY_MODE, ['sussy-bussy'], 0, true],
				["Rivals", "tomongus", 'tomo', FlxColor.fromRGB(255, 90, 134), FROM_STORY_MODE, ['rivals'], 0, true],
				["Chewmate", "hamster", 'ham', FlxColor.fromRGB(255, 90, 134), FROM_STORY_MODE, ['chewmate'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Tomongus Tuesday", "tuesday", 'tomo', FlxColor.fromRGB(255, 90, 134), SPECIAL, ['chewmate'], 0, true],
			],
		...
		weeks.push({
			songs: [
				["Christmas", "fella", 'loggo', FlxColor.fromRGB(0, 255, 0), FROM_STORY_MODE, ['christmas'], 0, true],
				["Spookpostor", "boo", 'loggo', FlxColor.fromRGB(0, 255, 0), FROM_STORY_MODE, ['spookpostor'], 0, true]
			],
		...
		weeks.push({
			songs: [
				["Titular", "henry", 'tit', FlxColor.ORANGE, FROM_STORY_MODE, ['titular'], 0, true],
				["Greatest Plan", "charles", 'charles', FlxColor.RED, FROM_STORY_MODE, ['greatest-plan'], 0, true],
				["Reinforcements", "ellie", 'ellie', FlxColor.ORANGE, FROM_STORY_MODE, ['reinforcements'], 0, true],
		...
		weeks.push({
			songs: [
				...
				["Drippypop", "drippy", 'pop', FlxColor.fromRGB(188, 106, 223), BEANS, [], 425, true],
		...
		weeks.push({
			songs: [
				...
				["Torture", "ziffy", 'torture', FlxColor.fromRGB(188, 106, 223), SPECIAL, ['chippin', 'chipping'], 0, true]
			],
