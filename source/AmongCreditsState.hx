...
class AmongCreditsState extends MusicBeatState
{
    private static var amongCreditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link
        ...
        ['CGGaT','clow','im CGGaT.... And I Coded A majority of this revival to give yall an actual V5','https://twitter.com/CodyGGaT'],
        ['4lkal1n3','alkaline','im 4lkal1n3 i did the double trouble and double kill','https://twitter.com/SkeXver'],
