...
{
	public static var psychEngineVersion:String = '5.0'; //This is also used for Discord RPC
			...
			if (FlxG.mouse.overlaps(spr))
			{
				...
				if(FlxG.mouse.pressed && canClick)
				{
					switch (optionShit[curSelected]) {
						case 'Gallery':
							FlxG.openURL('https://fridaynightfunking.fandom.com/wiki/VS._Impostor/Gallery#General');
						case 'Innersloth':
